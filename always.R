require(caret) 
require(e1071) 
tweetdat <- read.csv('Always_10p_Updated_Human.csv', as.is = T);
attach(eddat)
...
dm <- cbind(tweetdat["class"], scale(tweetdat[,c(1,2,3,4,6,7,8,9,10,11,13,15,16,17,18,19,20,21)]), tweetdat[,c(5,12,14,22)] )
